                                    ...
                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $item['IssueSituation'] ?></td>
                                                <td><?= $item['Department'] ?></td>
                                                <td><?= $item['Application'] ?></td>
                                                <td><?= $item['Reason'] ?></td>
                                                <td><input type="button" value="Forward"
                                                        class="btn btn-primary btn-sm refferComplaint" data-toggle="modal"
                                                        data-target=".bs-example-modal-md">
                                                    <!-- OR&nbsp;&nbsp; <input type="button" value="Reject"
...
<div class="modal fade bs-example-modal-md" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form id="refferForm" action="<?php echo base_url('department/refertomember');?>" method="post" data-parsley-validate>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-md-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2><small>Complaint refer to team leader by project leader</small></h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                    ...
                                    <select id="Team_Member_Id" name="Team_Member_Id" class="form-control" required>
                                        <option value="0">Choose Team Member..</option>
                                        <?php foreach($teamMember as $item): ?>
                                        <option value="<?= $item['User_Id'] ?>"><?= $item['U_Name']?>, <?= $item['Designation']?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <br />
                                    <label for="Explain">Explain Problem *:</label>
                                    <textarea name="Explain" id="Explain" cols="30" rows="5" class="form-control" placeholder="Write explanation here....."></textarea>                                
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $('.refferComplaint').click(function()
    {
